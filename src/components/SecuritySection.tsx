      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-slate-800/50 backdrop-blur-sm border border-green-500/30 rounded-2xl p-8"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-8"
          >
            <div className="flex items-start gap-4 mb-4">
        ...
        <motion.div
          ...
          className="bg-slate-800/30 backdrop-blur-sm border border-amber-500/50 rounded-2xl p-8"
        >
